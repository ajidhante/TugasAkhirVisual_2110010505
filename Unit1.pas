...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add('update data_siswa set nis="'+edt1.Text+'",nisn="'+edt2.Text+'",nik="'+edt3.Text+'",nama="'+edt4.Text+'",tempat_lahir="'+edt5.Text+'",tanggal_lahir="'+formatdatetime('yyyy-mm-dd',dtp1.Date)+'",jenis_kelamin="'+cbb1.Text+'",kelas="'+cbb2.Text+'",jurusan="'+cbb3.Text+'",id_walikelas="'+edt6.Text+'",alamat="'+edt7.Text+'",no_telepon="'+edt8.Text+'",status="'+edt9.Text+'" where id ="'+id+'"');
zqry1.ExecSQL ;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from data_siswa');
zqry1.Open;
